    ...
    <Row>
      ...
      <Col>
        {portfolio &&
          <>
            <h6>
              <span><Button className="edit"   onClick={handleEditNamePopup} /> Edit portfolio name</span>
              <span className="ms-3"><Button className="trash"  onClick={handleDeleteWarning} /> Delete portfolio</span>
            </h6>
